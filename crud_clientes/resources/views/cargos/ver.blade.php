...
<head>
    ...
    <title>Visualización de Cargo</title>
...
<header class="p-2 fixed-top bg-light">
    ...
    <h2 class="text-center mt-2">Visualización de Cargos</h2>
</header>
...
<body>
    <div class="container p-4" style="margin-top: 110px;">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header text-center font-weight-bold">Detalles de cargo específico</div>
                    ...
                    <div class="card-body">
                        <form method="post" action="{{route('actualizar',['id'=>$cargos->id])}}">
                            ...
                            <div class="container text-center pt-4">
                                <a href="{{url('cargos/index') }}" class="btn btn-primary">Volver</a>
                            </div>
                        </form>
                    </div>
                </div>
